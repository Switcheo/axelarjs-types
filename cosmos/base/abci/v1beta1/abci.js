...
exports.Result = {
    ...
    fromJSON(object) {
        return {
            ...
            log: isSet(object.log) ? String(object.log) : "",
            events: Array.isArray(object === null || object === void 0 ? void 0 : object.events) ? object.events.map((e) => types_1.Event.fromJSON(e)) : [],
            msgResponses: Array.isArray(object === null || object === void 0 ? void 0 : object.msgResponses)
    ...
    fromPartial(object) {
        ...
        message.totalCount =
            object.totalCount !== undefined && object.totalCount !== null
                ...
                : long_1.default.ZERO;
        message.count =
            object.count !== undefined && object.count !== null ? long_1.default.fromValue(object.count) : long_1.default.ZERO;
        message.pageNumber =
            object.pageNumber !== undefined && object.pageNumber !== null
                ? long_1.default.fromValue(object.pageNumber)
                : long_1.default.ZERO;
        message.pageTotal =
            object.pageTotal !== undefined && object.pageTotal !== null
                ...
                : long_1.default.ZERO;
        message.limit =
            object.limit !== undefined && object.limit !== null ? long_1.default.fromValue(object.limit) : long_1.default.ZERO;
