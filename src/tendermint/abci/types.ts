...
import { BlockIDFlag, blockIDFlagFromJSON, blockIDFlagToJSON } from "../../tendermint/types/validator";
...
export class ABCIClientImpl implements ABCI {
  ...
  ListSnapshots(request: RequestListSnapshots): Promise<ResponseListSnapshots> {
    ...
    const promise = this.rpc.request("tendermint.abci.ABCI", "ListSnapshots", data);
    return promise.then((data) => ResponseListSnapshots.decode(new _m0.Reader(data)));
  }

  OfferSnapshot(request: RequestOfferSnapshot): Promise<ResponseOfferSnapshot> {
    const data = RequestOfferSnapshot.encode(request).finish();
    const promise = this.rpc.request("tendermint.abci.ABCI", "OfferSnapshot", data);
    return promise.then((data) => ResponseOfferSnapshot.decode(new _m0.Reader(data)));
  }

  LoadSnapshotChunk(request: RequestLoadSnapshotChunk): Promise<ResponseLoadSnapshotChunk> {
    const data = RequestLoadSnapshotChunk.encode(request).finish();
    const promise = this.rpc.request("tendermint.abci.ABCI", "LoadSnapshotChunk", data);
    return promise.then((data) => ResponseLoadSnapshotChunk.decode(new _m0.Reader(data)));
  }

  ApplySnapshotChunk(request: RequestApplySnapshotChunk): Promise<ResponseApplySnapshotChunk> {
    const data = RequestApplySnapshotChunk.encode(request).finish();
    const promise = this.rpc.request("tendermint.abci.ABCI", "ApplySnapshotChunk", data);
  ...
  PrepareProposal(request: RequestPrepareProposal): Promise<ResponsePrepareProposal> {
    ...
    const promise = this.rpc.request("tendermint.abci.ABCI", "PrepareProposal", data);
  ...
  ProcessProposal(request: RequestProcessProposal): Promise<ResponseProcessProposal> {
    ...
    const promise = this.rpc.request("tendermint.abci.ABCI", "ProcessProposal", data);
  ...
  ExtendVote(request: RequestExtendVote): Promise<ResponseExtendVote> {
    ...
    const promise = this.rpc.request("tendermint.abci.ABCI", "ExtendVote", data);
  ...
  VerifyVoteExtension(request: RequestVerifyVoteExtension): Promise<ResponseVerifyVoteExtension> {
    ...
    const promise = this.rpc.request("tendermint.abci.ABCI", "VerifyVoteExtension", data);
  ...
  FinalizeBlock(request: RequestFinalizeBlock): Promise<ResponseFinalizeBlock> {
    ...
    const promise = this.rpc.request("tendermint.abci.ABCI", "FinalizeBlock", data);
