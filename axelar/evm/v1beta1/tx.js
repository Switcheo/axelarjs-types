...
exports.ConfirmTransferKeyRequest = {
    ...
    fromJSON(object) {
        return {
            ...
            transferTypeDeprecated: isSet(object.transferTypeDeprecated)
                ? (0, types_1.transferKeyTypeFromJSON)(object.transferTypeDeprecated)
                : 0,
    ...
    toJSON(message) {
        ...
        message.transferTypeDeprecated !== undefined &&
            (obj.transferTypeDeprecated = (0, types_1.transferKeyTypeToJSON)(message.transferTypeDeprecated));
...
exports.CreateDeployTokenRequest = {
    ...
    fromPartial(object) {
        ...
        message.address = (_d = object.address) !== null && _d !== void 0 ? _d : new Uint8Array();
...
exports.AddChainRequest = {
    ...
    fromPartial(object) {
        ...
        message.params = (_e = object.params) !== null && _e !== void 0 ? _e : new Uint8Array();
        message.sender = (_f = object.sender) !== null && _f !== void 0 ? _f : "";
        return message;
    },
};
