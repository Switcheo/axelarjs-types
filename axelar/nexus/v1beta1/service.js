...
class MsgServiceClientImpl {
    ...
    EnableLinkDeposit(request) {
        ...
        return promise.then((data) => tx_1.EnableLinkDepositResponse.decode(new _m0.Reader(data)));
    }
    DisableLinkDeposit(request) {
        ...
        return promise.then((data) => tx_1.DisableLinkDepositResponse.decode(new _m0.Reader(data)));
    }
    UpdateParams(request) {
        ...
        return promise.then((data) => tx_1.UpdateParamsResponse.decode(new _m0.Reader(data)));
    }
}
...
class QueryServiceClientImpl {
    ...
    LinkDepositEnabled(request) {
        ...
        return promise.then((data) => query_1.LinkDepositEnabledResponse.decode(new _m0.Reader(data)));
    }
}
