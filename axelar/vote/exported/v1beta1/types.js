...
exports.Vote = {
    ...
    fromJSON(object) {
        return {
            resultsDeprecated: Array.isArray(object === null || object === void 0 ? void 0 : object.resultsDeprecated)
    ...
    toJSON(message) {
        ...
        if (message.resultsDeprecated) {
            obj.resultsDeprecated = message.resultsDeprecated.map((e) => (e ? any_1.Any.toJSON(e) : undefined));
        }
        else {
