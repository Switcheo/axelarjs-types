...
exports.TalliedVote = {
    ...
    fromJSON(object) {
        return {
            ...
            votersDeprecated: Array.isArray(object === null || object === void 0 ? void 0 : object.votersDeprecated)
                ? object.votersDeprecated.map((e) => bytesFromBase64(e))
                : [],
    ...
    toJSON(message) {
        ...
        if (message.votersDeprecated) {
            obj.votersDeprecated = message.votersDeprecated.map((e) => base64FromBytes(e !== undefined ? e : new Uint8Array()));
        }
        else {
